...
s_mod <- lmer(stress ~ per_income * erq_reap + (1|day:survey), data = redcap_ema_survey[redcap_ema_survey$per_income != 14,])
summary(s_mod)

s_mod <- lmer(stress ~ ladd_comm + gender + (1|day:survey), data = redcap_ema_survey)
summary(s_mod)


s_mod <- lmer(nervous ~ per_income * erq_reap + (1|day:survey), data = redcap_ema_survey[redcap_ema_survey$per_income != 14,])
summary(s_mod)
...
s_mod <- glmer(stress_exp ~ ladd_comm * scale(erq_reap) + (1|day:survey), data = redcap_ema_survey, family = "binomial")
summary(s_mod)
```
